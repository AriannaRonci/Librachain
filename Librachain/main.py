...
if __name__ == "__main__":
    ...
    invoke_onchain.get_balance('http://localhost:8548')
    invoke_onchain.get_address_list('http://localhost:8548')
    ...
    print(invoke_onchain.get_address_list('http://localhost:8545'))
    ...
    contract_functions, contract, functions = shards_controller.by_abi("0xe78A0F7E598Cc8b0Bb87894B0F60dD2a88d6a8Ab", [
        {
            "inputs": [],
            "name": "retrieve",
            "outputs": [
    ...
    for i in range(0, len(functions)):
        print("result =" + str(functions))
        print(functions[i])
        i = 0
        #contract.functions.functions[i].call()
